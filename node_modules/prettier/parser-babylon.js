!(function(t, e) {
    ...
    v = s(function(t, e) {
      ...
      (h.parenR.updateContext = h.braceR.updateContext = function() {
        ...
        (h._function.updateContext = h._class.updateContext = function(t) {
          ...
          ((t === h.colon || t === h.braceL) && this.curContext() === x.b_stat)
        ...
        return t < 65
          ...
          : t <= 90 ||
              (t < 97
                ...
                : t <= 122 ||
                  (t <= 65535
                    ? t >= 170 && T.test(String.fromCharCode(t))
                    : C(t, E)));
      }
      function S(t) {
        return t < 48
      ...
      (x.j_oTag = new y("<tag", !1)),
        ...
        (h.jsxTagEnd.updateContext = function(t) {
          ...
          (e === x.j_oTag && t === h.slash) || e === x.j_cTag
            ? (this.state.context.pop(),
              ...
              var i = void 0 === s ? {} : s,
                ...
                n = (function(t, e) {
                  var s,
                    i = 1,
                    r = 0;
                  for (u.lastIndex = 0; (s = u.exec(t)) && s.index < e; )
                    i++, (r = u.lastIndex);
                  return new U(i, e - r);
                })(this.input, t);
              e += " (" + n.line + ":" + n.column + ")";
            ...
            (function() {
              ...
              return (
                (e.isReservedWord = function(t) {
                  return "await" === t ? this.inModule : P[6](t);
                }),
          ...
          (function(t) {
            ...
            return (
              ...
              (s.readToken = function(t) {
                k(t) || 92 === t ? this.readWord() : this.getTokenFromCode(t);
              }),
              ...
              (s.skipBlockComment = function() {
                ...
                for (
                  -1 === i &&
                    ...
                    this.state.pos = i + 2,
                    u.lastIndex = s;
                  (t = u.exec(this.input)) && t.index < this.state.pos;
              ...
              (s.braceIsBlock = function(t) {
                ...
                return (
                  ...
                  (t !== h.colon ||
                  (e !== x.braceStatement && e !== x.braceExpression)
                    ? t === h._return ||
                      t === h._yield ||
            ...
            return (function(t) {
              ...
              return (
                ...
                (s.readToken = function(e) {
                  ...
                  if (s === x.j_expr) return this.jsxReadToken();
                  if (s === x.j_oTag || s === x.j_cTag) {
                    if (k(e)) return this.jsxReadWord();
                    if (62 === e)
                      return ++this.state.pos, this.finishToken(h.jsxTagEnd);
                    if ((34 === e || 39 === e) && s === x.j_oTag)
                ...
                (s.parseImportSpecifiers = function(e) {
                  ...
                  if (
                    ...
                    "type" === s &&
                      ...
                      (O(i) || i.type === h.braceL || i.type === h.star) &&
                ...
                (s.parseMaybeAssign = function(e, s, i, r) {
                  ...
                  if (
                    ...
                    try {
                      ...
                      this.state = o;
                      var p = this.state.context.length;
                      this.state.context[p - 1] === x.j_oTag &&
                        (this.state.context.length -= 2),
                        (n = t);
                    }
                  }
                  if (null != n || this.isRelational("<")) {
                    ...
                    try {
                      (l = this.flowParseTypeParameterDeclaration()),
                        ((c = this.forwardNoArrowParamsConversionAt(
                          l,
                          function() {
                            return t.prototype.parseMaybeAssign.call(
                              a,
                        ...
                        this.resetStartLocationFromNode(c, l);
                    } catch (t) {
                      throw n || t;
                    }
                    if ("ArrowFunctionExpression" === c.type) return c;
                    if (null != n) throw n;
                    this.raise(
                      l.start,
  ...
  function b(e) {
    return function(s, i, r) {
      ...
      return delete a.tokens, x(a, Object.assign({}, r, { originalText: s }));
    };
  }
  var w = b("parse"),
    T = b("parseExpression");
  ...
  var E = Object.assign({ parse: w, astFormat: "estree", hasPragma: P }, c),
    N = Object.assign({}, E, { parse: T });
  return {
    parsers: {
      babylon: E,
      ...
      "json-stringify": Object.assign(
        {
          parse: function(t, e, s) {
            var i = T(t, e, s);
            return i.comments.forEach(A), A(i), i;
          },
